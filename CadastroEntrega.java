...
public class CadastroEntrega extends JDialog {
	...
	public boolean validaFormulario() {
		return (!txtCodigoEntrega.getText().equals("") && !txtDescricaoProdutoEntrega.getText().equals("")
				&& !txtDescricaoDestinoEntrega.getText().equals("") && !txtDistanciaEntrega.getText().equals("")
